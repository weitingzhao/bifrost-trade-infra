...
4. Use MCP `report_phase_progress` (server `bifrost-platform`) with the session_id from the pack to report progress.
...
- Follow all workspace rules (`CLAUDE.md` + `AGENT_FACTS.md`) and each repo's own CLAUDE.md.
